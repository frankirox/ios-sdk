...
public class Moltin {
    ...
    */
    ...
    public func customer(withCustomerToken customerToken: String) -> CustomerRequest {
        let request = CustomerRequest(withConfiguration: self.config)
        request.moltinCustomerToken = customerToken
        return request
    }
    ...
    public func order(withCustomerToken customerToken: String) -> OrderRequest {
        let request = OrderRequest(withConfiguration: self.config)
        request.moltinCustomerToken = customerToken
        return request
    }
